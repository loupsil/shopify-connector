...
For more information, visit https://www.dasolo.ai/odoo-shopify-connector
    ...
    'assets': {
        'web.assets_backend': [
            'shopify_connector__dasolo/static/src/css/shopify_connector.css',
            'shopify_connector__dasolo/static/src/js/shopify_connector.js',
            'shopify_connector__dasolo/static/src/xml/shopify_connector.xml',
        ],
    },
